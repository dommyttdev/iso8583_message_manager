...
`iso8583-msg-cli` コマンドは、ISO 8583 金融メッセージのエンコード・デコードをコマンドラインから行うツールです。
...
インストール後、`iso8583-msg-cli` コマンドが使用可能になります。
...
```
iso8583-msg-cli [OPTIONS] COMMAND [ARGS]...
```
...
```
iso8583-msg-cli generate [OPTIONS] MTI [FIELDS]...
```
...
```bash
$ iso8583-msg-cli generate 0200 primary_account_number=1234567890123456 \
    --output binary \
...
```
iso8583-msg-cli parse [OPTIONS] [HEX_MESSAGE]
```
...
```
iso8583-msg-cli fields [OPTIONS]
```
...
```
iso8583-msg-cli mti-types [OPTIONS]
```
...
詳細な桁値と意味は `iso8583-msg-cli mti-types` コマンドで確認できます。
...
# 生成したメッセージを解析
iso8583-msg-cli parse "$HEX" --output table --spec data/schemas/iso8583_fields.json
```
...
iso8583-msg-cli generate 0200 primary_account_number=1234567890123456 \
    --spec data/schemas/iso8583_fields.json \
  | iso8583-msg-cli parse --output table --spec data/schemas/iso8583_fields.json
```
