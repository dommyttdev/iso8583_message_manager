...
iso8583 package supports custom [specifications](specifications.md) that can define:
...
Additional information is available on [Read The Docs](http://pyiso8583.readthedocs.org).

### Installation

iso8583 is published on [PyPI](https://pypi.org/project/pyiso8583/) as pyiso8583 and can be installed from there:
...
Use [iso8583.decode](functions.md#iso8583.decode(s,%20spec)) to decode raw ISO8583 message. It returns two dictionaries: one with decoded data and one with encoded data.
...
Use [iso8583.pp](functions.md#iso8583.pp(doc,%20spec,%20desc_width=30,%20stream=None,%20line_width=80)) to pretty print ISO8583 message.
...
iso8583 package is hosted on [GitHub](https://github.com/knovichikhin/pyiso8583). Feel free to fork and send contributions over.
